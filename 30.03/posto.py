...
Escreva um algoritmo que leia o numero de litros vendidos, o tipo de combustivel
(A-alcool, G-gasolina) e imprima o valor a ser pago pelo cliente.

Considere que o preco do litro da gasolina e R$ 6,89 e o preco do litro do
alcool e R$ 4,89.'''
